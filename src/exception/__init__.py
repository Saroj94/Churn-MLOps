...
def error_message_detail(error: Exception, error_detail: sys) -> str:
    ...
    ##give us the name of the file where the exception occurred
...
class MyException(Exception):
    """
    Custom exception class for handling errors in the Churn project application.
    """
    def __init__(self, error_message: str, error_detail: sys):
        """
        Initializes the Project Exception with a detailed error message.
