...
class SimpleStorageService:
    ...
    @staticmethod
    def read_object(object_name: Union[object, List[object]], decode: bool = True, make_readable: bool = False) -> Union[StringIO, str]:
        try:
    ...
    def get_file_object(self, filename: str, bucket_name: str) -> object:
        ...
        try:
            ...
            if not file_objects:
                raise FileNotFoundError(f"No file found in bucket '{bucket_name}' with key prefix '{filename}'")
            
            #Return the first file (safe to do now)
